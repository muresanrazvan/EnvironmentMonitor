...
//    Serial.print(" & TVOC: 0x"); Serial.println(TVOC_base, HEX);
  ...
  if(loopCounter>=30){
    ...
    Serial.print(getLight()); Serial.println(" Lux");
    Serial.print(sumSound/30.0); Serial.println(" dB");
    Serial.print(sumTVOC/30.0); Serial.println(" ppb");
    Serial.print(sumECO2/30.0); Serial.println(" ppm");
